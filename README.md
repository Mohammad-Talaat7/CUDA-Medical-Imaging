# Medical Imaging Analysis with CUDA and NPP

## Overview

This project demonstrates the use of NVIDIA Performance Primitives (NPP) library with CUDA to perform Medical Imaging Noise Reduction. The goal is to utilize GPU acceleration to efficiently filter gaussian a given image by NPP, leveraging the computational power of modern GPUs. The project is a part of the CUDA at Scale for the Enterprise course.
